...
`git clone https://github.com/Reygie23/fb_reygie_v3`
<br>
`cd messenger-openai`
<br>
`node execute.js`
...
Download cookie editor add it to your browser extension
after that add you cookies at sesion.json file
replace the "name" to "key" for the top and down
## Changelogs:
